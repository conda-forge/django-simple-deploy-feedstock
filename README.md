...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-simple-deploy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15075&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-simple-deploy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-simple-deploy` can be installed with:

```
conda install django-simple-deploy
```

It is possible to list all of the versions of `django-simple-deploy` available on your platform with:
